...
//https://www.youtube.com/watch?v=fOOpUvHlO2c

const getPhotosByAlbumId = async (id: string | number) => {
    const result = await axios.request({
        method: 'get',
        url: `https://jsonplaceholder.typicode.com/albums/${id}/photos?_limit=3`
    });
    const { data } = result;
    return data;
};
